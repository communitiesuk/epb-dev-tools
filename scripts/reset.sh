...
if [[ -z $(confirm "Do you want to reset and configure the dev environment?") ]]; then
  ...
  docker-compose exec -T epb-auth-server-db bash -c "psql --username epb -d epb -c \"INSERT INTO client_scopes (client_id, scope) VALUES ('5e7b7607-971b-45a4-9155-cb4f6ea7e9f5', 'assessment:fetch'), ('5e7b7607-971b-45a4-9155-cb4f6ea7e9f5', 'assessment:fetch_for_warehouse');\""
